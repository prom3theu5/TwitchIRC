...
namespace TwitchLib.TwitchIRC
{
    ...
    public class IrcConnection
    {
        ...
        public async Task ConnectAsync(string[] addresslist, int port)
        {
            if (_IsConnected) {
            ...
            try {
                ...
                if (_UseSsl) {
                    ...
                    try {
                        if (_SslClientCertificate != null) {
                            ...
                            await sslStream.AuthenticateAsClientAsync(Address, certs,
                                                           SslProtocols.Tls,
                                                           false);
                        } else {
                ...
                if (_AutoRetry &&
                    ...
                    await ConnectAsync(_AddressList, _Port);
                } else {
        ...
        {
            await ConnectAsync(new string[] { address }, port);
        }
